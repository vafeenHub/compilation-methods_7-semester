...
private:
    ...
    void initializeTables() {
        ...
        productions = {
            {"S'", 1, [](std::vector<std::shared_ptr<ASTNode>>& children) { return children[0]; }},
            ...
            {"Body", 1, [](std::vector<std::shared_ptr<ASTNode>>& children) { return children[0]; }},
        ...
        actionTable = {
            ...
            {6, {{TokenType::LESS, {REDUCE, 8}}, {TokenType::GREATER, {REDUCE, 8}}, {TokenType::EQUAL, {REDUCE, 8}}, 
                 {TokenType::RPAREN, {REDUCE, 8}}, {TokenType::ASSIGN, {REDUCE, 8}}, {TokenType::DONE, {REDUCE, 8}}}},
            {7, {{TokenType::LESS, {REDUCE, 9}}, {TokenType::GREATER, {REDUCE, 9}}, {TokenType::EQUAL, {REDUCE, 9}}, 
                 {TokenType::RPAREN, {REDUCE, 9}}, {TokenType::ASSIGN, {REDUCE, 9}}, {TokenType::DONE, {REDUCE, 9}}}},
    ...
    std::string getTokenTypeName(TokenType type) const {
        switch (type) {
            ...
            case TokenType::ROMAN_NUMERAL: return "ROMAN_NUMERAL";
...
public:
    ...
    std::shared_ptr<ASTNode> parse() {
        ...
        while (true) {
            ...
            std::string tokenValue = getTokenValue();
            
            // Пропускаем вывод для чистоты
            // std::cout << "Состояние: " << currentState 
            //          << ", Токен: " << getTokenTypeName(currentToken) 
            //          << " ('" << tokenValue << "')\n";
            ...
            switch (entry.action) {
                case SHIFT: {
                    // std::cout << "  SHIFT -> состояние " << entry.value << "\n";
                ...
                case REDUCE: {
                    ...
                    // std::cout << "  REDUCE по правилу " << entry.value 
                    //          << " (" << prod.lhs << " -> " << prod.rhsSize << " символов)\n";
                    ...
                    // std::cout << "  GOTO состояние " << gotoEntry->second << "\n";
                    break;
                }
                case ACCEPT: {
            ...
            // Пропускаем вывод стека для чистоты
